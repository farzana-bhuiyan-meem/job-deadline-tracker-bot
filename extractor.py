...
def extract_job_details_gemini(text: str, url: str) -> Dict:
    """
...
3. Application Deadline (in YYYY-MM-DD format, if mentioned)
4. Salary Range (if mentioned)
5. Location
6. Brief Description (max 200 characters)
...
If any field is not found, use null. Do not include any explanation or additional text, only the JSON.
"""
